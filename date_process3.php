...
"><a href="date_search3.php"><i><b><<-Back</b></i></a></div>
    ...
    $to_date=$_GET["dat2"];
      ...
      $sql= "SELECT AttendingPhysician, Count(AttendingPhysician) FROM user_info WHERE dat BETWEEN '" . $from_date . "' AND  '" . $to_date . "'group by AttendingPhysician";
