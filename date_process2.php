...
"><a href="date_search2.php"><i><b><<-Back</b></i></a></div>
    ...
    $to_date=$_GET["dat2"];
      ...
      $sql= "SELECT Department,Count(Department) FROM user_info WHERE dat BETWEEN '" . $from_date . "' AND  '" . $to_date . "'group by Department";
