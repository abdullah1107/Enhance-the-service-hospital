...
$s="SELECT AttendingPhysician, Count(AttendingPhysician)FROM user_info WHERE 1 group by AttendingPhysician";
...
echo "<tr>";
    echo"<th>AttendingPhysician Name</th>";
    echo "<th>Quantity  AttendingPhysician</th>";
